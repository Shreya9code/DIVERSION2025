      ...
      <div>
        {appointments.length === 0 ? (
          ...
          appointments.map((item, index) => (
            <div key={index} className="grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b mt-3">
              <div>
                {item.docData?.image ? (
                  <img className="w-32 bg-teal-50" src={item.docData.image} alt="Doctor" />
                ) : (
                  <p>No image</p>
                )}
              </div>
